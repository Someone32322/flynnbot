...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("duration")
    .setDescription("Update the duration on an active moderation case.")
  ...
  async execute(interaction) {
    ...
    await logCaseToAudit(interaction.guild, guildConfig, caseDocument, [], getAuditColor("duration"));
    await interaction.reply(
      buildStaffReply("duration", { caseDocument, duration: formatDuration(durationMs) })
    );
  },
};
