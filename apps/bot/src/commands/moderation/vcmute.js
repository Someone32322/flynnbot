...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addUserOption((option) => option.setName("user").setDescription("Member to voice mute").setRequired(true))
  ...
  async execute(interaction) {
    ...
    await target.targetMember.voice.setMute(true, reason);
    ...
    await logCaseToAudit(interaction.guild, guildConfig, caseDocument, [], getAuditColor("vcmute"));
    await interaction.reply(buildStaffReply("vcmute", { targetUser: target.targetUser, caseDocument }));
  },
};
