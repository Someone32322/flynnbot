...
module.exports = {
  ...
  'level-set': {
    ...
    usage: '/level-set <user> <level>',
    aliases: [],
  },
  'xp-set': {
    category: 'Levels',
    description: 'Set a user\'s XP directly.',
    usage: '/xp-set <user> <xp>',
    aliases: [],
  },
  'xp-add': {
    category: 'Levels',
    description: 'Add XP to a user and process level-up rewards.',
    usage: '/xp-add <user> <amount>',
    aliases: [],
  },
  'xp-remove': {
    category: 'Levels',
    description: 'Remove XP from a user and recalculate level.',
    usage: '/xp-remove <user> <amount>',
    aliases: [],
  },
  'level-reset': {
    category: 'Levels',
    description: 'Reset a user\'s XP and level to defaults.',
    usage: '/level-reset <user> <confirm>',
    aliases: [],
  },
  'level-toggle': {
    category: 'Levels',
    description: 'Enable or disable leveling for this server.',
    usage: '/level-toggle <enabled>',
    aliases: [],
  },
  'level-config': {
    category: 'Levels',
    description: 'Display current leveling configuration.',
    usage: '/level-config',
    aliases: [],
  },
  'xp-rate': {
  ...
  'xp-channel': {
    category: 'Levels',
    description: 'Add/remove/list channels where XP can be earned.',
    usage: '/xp-channel <action> [channel]',
    aliases: [],
  },
  'level-reward-add': {
    category: 'Levels',
    description: 'Assign a role reward for a level.',
    usage: '/level-reward-add <level> <role>',
    aliases: [],
  },
  'level-reward-remove': {
    category: 'Levels',
    description: 'Remove a role reward from a level.',
    usage: '/level-reward-remove <level>',
    aliases: [],
  },
  'level-rewards': {
    category: 'Levels',
  ...
  'level-message': {
    category: 'Levels',
    description: 'Set or display the level-up message template.',
    usage: '/level-message [template]',
    aliases: [],
  },
  'level-channel': {
    category: 'Levels',
  ...
  'level-role-stack': {
    category: 'Levels',
    description: 'Toggle whether users keep all level reward roles.',
    usage: '/level-role-stack <enabled>',
    aliases: [],
  },
  'xp-giveall': {
    category: 'Levels',
    description: 'Give XP to all non-bot members in the server.',
    usage: '/xp-giveall <amount>',
    aliases: [],
  },
  'level-import': {
    category: 'Levels',
    description: 'Import leveling data from a JSON attachment.',
    usage: '/level-import <file>',
    aliases: [],
  },
  'level-export': {
    category: 'Levels',
    description: 'Export leveling data to a JSON file.',
    usage: '/level-export',
    aliases: [],
  },
  'level-formula': {
    category: 'Levels',
    description: 'Set or display the XP formula constants.',
    usage: '/level-formula [a] [b] [c]',
    aliases: [],
  },
};
